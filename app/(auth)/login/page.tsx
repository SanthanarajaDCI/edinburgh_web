...
import { Diamond, User, Lock, Eye, EyeOff, Fingerprint } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center bg-[var(--background)] p-12">
          <div className="relative w-full max-w-[440px] aspect-[3/4] rounded-3xl overflow-hidden shadow-[var(--shadow-xl)]">
            <Image
              src="https://picsum.photos/seed/cashmere-hero/800/1100"
              alt="Edinburgh Cashmere Heritage"
              fill
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              ...
              <p className="text-white/80 text-sm mt-3 leading-relaxed">
                Discover the timeless elegance of Scottish craftsmanship, woven
                into every fiber of our finest collections.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12 lg:px-12">
          <div className="w-full max-w-[420px]">
            ...
            <p className="text-center text-sm text-[var(--text-secondary)] mt-2">
              Sign in to your Edinburgh Cashmere account
            </p>
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button
                    type="button"
                    className="text-xs font-bold text-[var(--accent)] hover:text-[var(--accent-hover)] transition-default"
                  >
                    Forgot Password?
                  </button>
                </div>
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[var(--text-secondary)] hover:text-[var(--primary)] transition-default"
                  >
                    {showPassword ? (
              ...
              <Link
                href="/verify"
                className="block w-full py-3.5 text-center border border-[var(--border-medium)] text-[var(--primary)] text-sm font-bold rounded-xl hover:bg-[var(--primary-light)] transition-default"
              >
                Login with OTP
              </Link>
            </form>
            ...
            <div className="flex items-center justify-center gap-6 mt-6">
              {/* <button className="flex items-center gap-2 text-sm text-[var(--text-primary)] hover:text-[var(--primary)] transition-default">
      ...
      <footer className="bg-[var(--primary)] py-6">
        <div className="max-w-[1280px] mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <p className="text-playfair text-lg font-bold italic text-white">
              Edinburgh Cashmere
            </p>
          ...
          <div className="flex items-center gap-6">
            <span className="text-xs text-white/40 hover:text-[var(--accent)] transition-default cursor-pointer">
              Privacy Policy
            </span>
            <span className="text-xs text-white/40 hover:text-[var(--accent)] transition-default cursor-pointer">
              Terms of Service
